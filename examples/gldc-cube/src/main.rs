...
static CLAW_DATA: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/tex_claw.vq"));
static DC_DATA: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/tex_dc.vq"));
static DCWIKI_DATA: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/tex_dcwiki.vq"));
static GCC_DATA: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/tex_gcc.vq"));
static KOS_DATA: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/tex_kos.vq"));
static RUST_DATA: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/tex_rust.vq"));
